...
describe("ParallelModuleCreationPipeline", () => {
  ...
  it("connection: organization/DependencyGraph → convergence/ParallelModuleCreation", () => {
  ...
  it("connection: convergence/ParallelModuleCreation → convergence/ParallelModuleCreation", () => {
  ...
  it("connection: graph/ModuleFile → convergence/ParallelModuleCreation", () => {
