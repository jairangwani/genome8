...
describe("StopConvergenceFromCLI", () => {
  ...
  it("connection: convergence/ConvergenceCLI → convergence/StopConvergenceProcesses", () => {
  ...
  it("connection: convergence/StopConvergenceProcesses → convergence/StopConvergenceProcesses", () => {
  ...
  it("connection: convergence/StopConvergenceProcesses → convergence/ConvergenceCLI", () => {
