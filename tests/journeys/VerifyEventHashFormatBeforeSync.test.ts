...
describe("VerifyEventHashFormatBeforeSync", () => {
  ...
  it("connection: events/ValidateEventHashFormat → events/ValidateEventHashFormat", () => {
  ...
  it("connection: events/ValidateEventHashFormat → events/HandleInvalidEventPayload", () => {
