...
describe("RecoverFromNodeStubMismatch", () => {
  ...
  it("connection: codegen/FilledSourceFile → codegen/DetectNodeStubMismatch", () => {
  ...
  it("connection: codegen/DetectNodeStubMismatch → codegen/RetryFillWithErrorFeedback", () => {
  ...
  it("connection: llm/ReceiveResult → codegen/DetectNodeStubMismatch", () => {
