...
describe("ParseAllModules", () => {
  ...
  it("step 10: compilation/JourneyNameValidation validates each journey name follows PascalCase format and warns on special characters", () => {
  ...
  it("step 11: graph/JourneyDefinition parses each journey entry from the parsed YAML", () => {
    // Node: graph/JourneyDefinition (process)
    // Action: parses each journey entry from the parsed YAML
    // TODO: agent fills assertion
  });

  it("connection: compilation/JourneyNameValidation → graph/JourneyDefinition", () => {
    // Assert that the output of step 10 feeds into step 11
    // TODO: agent fills connection assertion
  });

  it("step 12: graph/NodeRegistry registers all parsed nodes into the deduplicated map", () => {
  ...
  it("step 13: graph/JourneyRegistry registers all parsed journeys into the journey collection", () => {
  ...
  it("step 14: graph/CompiledIndex merges all parsed modules into the in-memory compiled structure", () => {
