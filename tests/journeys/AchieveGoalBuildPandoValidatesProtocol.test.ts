...
// Modules touched: _goals, _actors, hierarchy, audit
...
describe("AchieveGoalBuildPandoValidatesProtocol", () => {
  it("step 1: _goals/GenomeIsTheProduct asserts Pando proves genome8 works on a system genome8 did not build", () => {
  ...
  it("step 6: _goals/ProductionReady confirms Pando passed the same production-quality gates as genome8 itself", () => {
    // Node: _goals/ProductionReady (rule)
    // Action: confirms Pando passed the same production-quality gates as genome8 itself
    // TODO: agent fills assertion
  });

  it("step 7: _goals/SelfSustaining confirms Pando's graph auto-updates when its spec changes — the protocol scales beyond genome8", () => {
