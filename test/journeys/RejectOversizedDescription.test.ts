...
describe("RejectOversizedDescription", () => {
  ...
  it("connection: _actors/RogueWorker → graph/NodeDefinition", () => {
  ...
  it("connection: graph/NodeDefinition → graph/EnforceDescriptionSizeLimit", () => {
  ...
  it("connection: graph/EnforceDescriptionSizeLimit → _actors/Compiler", () => {
