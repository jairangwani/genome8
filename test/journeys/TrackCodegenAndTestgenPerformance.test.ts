...
describe("TrackCodegenAndTestgenPerformance", () => {
  ...
  it("connection: convergence/TriggerCodegen → metrics/StartStepTimer", () => {
  ...
  it("connection: metrics/StartStepTimer → codegen/ReadConvergedGraph", () => {
  ...
  it("connection: codegen/ReadConvergedGraph → metrics/EndStepTimer", () => {
  ...
  it("connection: metrics/StartStepTimer → testgen/ReadJourneySteps", () => {
  ...
  it("connection: testgen/ReadJourneySteps → metrics/EndStepTimer", () => {
