...
describe("DetectAndRetryFailedOutgoingEvent", () => {
  ...
  it("connection: publish/WriteEventFile → sync/VerifyOutgoingEventWritten", () => {
  ...
  it("connection: sync/VerifyOutgoingEventWritten → sync/VerifyOutgoingEventWritten", () => {
  ...
  it("connection: sync/VerifyOutgoingEventWritten → publish/WriteEventFile", () => {
  ...
  it("connection: sync/VerifyOutgoingEventWritten → publish/EventFile", () => {
  ...
  it("connection: publish/EventFile → sync/SyncResult", () => {
