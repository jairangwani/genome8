...
describe("HandleChildConvergenceFailure", () => {
  ...
  it("connection: hierarchy/MonitorChildConvergence → hierarchy/DetectChildProcessFailure", () => {
  ...
  it("connection: hierarchy/DetectChildProcessFailure → hierarchy/ChildConvergenceStatus", () => {
