...
describe("FinalizeAndPersistMetrics", () => {
  ...
  it("connection: convergence/TriggerPublish → metrics/FinalizeMetrics", () => {
  ...
  it("connection: metrics/FinalizeMetrics → metrics/ConvergenceMetricsRecord", () => {
  ...
  it("connection: metrics/ConvergenceMetricsRecord → metrics/WriteMetricsToDisk", () => {
  ...
  it("connection: metrics/WriteMetricsToDisk → metrics/MetricsJsonFile", () => {
  ...
  it("connection: metrics/MetricsJsonFile → _actors/HumanDeveloper", () => {
