...
describe("HandleSelfHealingCycleExhaustion", () => {
  ...
  it("connection: convergence/ClassifyBlockerType → convergence/CreateBlockerJourney", () => {
  ...
  it("connection: convergence/ExecuteTests → convergence/VerifyGoalsAgainstEvidence", () => {
  ...
  it("connection: convergence/VerifyGoalsAgainstEvidence → convergence/DetectSelfHealingExhaustion", () => {
  ...
  it("connection: convergence/DetectSelfHealingExhaustion → convergence/DetectSelfHealingExhaustion", () => {
  ...
  it("connection: convergence/DetectSelfHealingExhaustion → convergence/NeverOpenEndedLoop", () => {
  ...
  it("connection: convergence/NeverOpenEndedLoop → convergence/VerifyGoalsAgainstEvidence", () => {
  ...
  it("connection: convergence/VerifyGoalsAgainstEvidence → compilation/ErrorReport", () => {
  ...
  it("connection: compilation/ErrorReport → convergence/FlagSpecGap", () => {
