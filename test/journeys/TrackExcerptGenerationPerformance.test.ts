...
describe("TrackExcerptGenerationPerformance", () => {
  ...
  it("connection: convergence/ModuleCreation → metrics/StartStepTimer", () => {
  ...
  it("connection: metrics/StartStepTimer → excerpt/SelectTargetModule", () => {
  ...
  it("connection: excerpt/TruncateToLimit → metrics/EndStepTimer", () => {
