...
describe("CompileFromInMemoryModules", () => {
  ...
  it("step 7: compilation/DanglingRefDetection checks every journey step ref against the node registry", () => {
    // Node: compilation/DanglingRefDetection (process)
    // Action: checks every journey step ref against the node registry
    // TODO: agent fills assertion
  });

  it("connection: compilation/NodeNameValidation → compilation/DanglingRefDetection", () => {
    // Assert that the output of step 6 feeds into step 7
    // TODO: agent fills connection assertion
  });

  it("step 8: compilation/ExternalInterfaceResolution resolves cross-engine refs against published interfaces when provided", () => {
  ...
  it("step 9: compilation/ExternalRefClassification classifies remaining unresolved external refs as warnings", () => {
  ...
  it("step 10: graph/ConnectionComputation computes all connections from consecutive journey steps", () => {
  ...
  it("step 11: compilation/OrphanDetection identifies nodes not referenced in any journey", () => {
  ...
  it("step 12: compilation/StatsComputation computes aggregate statistics for the compiled graph", () => {
  ...
  it("step 13: compilation/CoverageComputation computes per-module coverage metrics with orphan and isolated module lists", () => {
  ...
  it("step 14: compilation/CompilationResult assembles the compiled index, issues, and coverage into the final result", () => {
