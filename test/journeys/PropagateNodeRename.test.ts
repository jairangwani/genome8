...
describe("PropagateNodeRename", () => {
  ...
  it("connection: graph/NodeRegistry → graph/CrossModuleImpactScan", () => {
  ...
  it("connection: graph/CrossModuleImpactScan → graph/JourneyRegistry", () => {
  ...
  it("connection: graph/JourneyRegistry → graph/CrossModuleRefResolution", () => {
  ...
  it("connection: graph/CrossModuleRefResolution → graph/ConnectionComputation", () => {
  ...
  it("connection: graph/ConnectionComputation → graph/ConnectionSet", () => {
