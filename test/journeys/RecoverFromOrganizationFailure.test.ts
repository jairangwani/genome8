...
describe("RecoverFromOrganizationFailure", () => {
  ...
  it("connection: _actors/LLMWorker → organization/OrganizationFile", () => {
  ...
  it("connection: organization/OrganizationFile → organization/ValidateLLMOrganizationOutput", () => {
  ...
  it("connection: organization/ValidateLLMOrganizationOutput → compilation/ErrorReport", () => {
  ...
  it("connection: convergence/BoundedRetryRule → convergence/RetryOrganization", () => {
  ...
  it("connection: convergence/RetryOrganization → _actors/LLMWorker", () => {
  ...
  it("connection: organization/ValidateLLMOrganizationOutput → convergence/ConvergenceState", () => {
