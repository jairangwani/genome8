...
describe("EnforceArchitecturalDecisions", () => {
  ...
  it("connection: _actors/ProjectOwner → convergence/WarmWorkersAcrossPhases", () => {
  ...
  it("connection: convergence/WarmWorkersAcrossPhases → _actors/LLMWorker", () => {
  ...
  it("connection: _actors/LLMWorker → convergence/BoundedCreationRule", () => {
  ...
  it("connection: convergence/BoundedCreationRule → convergence/BatchHeavyOperations", () => {
  ...
  it("connection: convergence/BatchHeavyOperations → llm/PayloadSizeBudget", () => {
  ...
  it("connection: llm/PayloadSizeBudget → convergence/DataDecidesWhenToStop", () => {
  ...
  it("connection: convergence/DataDecidesWhenToStop → graph/DestructiveEditProtectionRule", () => {
  ...
  it("connection: graph/DestructiveEditProtectionRule → codegen/NeverOverwriteExisting", () => {
  ...
  it("connection: codegen/NeverOverwriteExisting → convergence/AutoScaffoldProjectFiles", () => {
