...
describe("DrainLargePayloadBackpressure", () => {
  ...
  it("connection: llm/SendTask → llm/HandleStdinBackpressure", () => {
  ...
  it("connection: llm/HandleStdinBackpressure → llm/HandleStdinBackpressure", () => {
  ...
  it("connection: llm/HandleStdinBackpressure → llm/StreamJsonProtocol", () => {
