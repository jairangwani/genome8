...
describe("ResumeAlreadyConvergedBox", () => {
  ...
  it("connection: convergence/LoadProjectConfig → convergence/WritePidFile", () => {
  ...
  it("connection: convergence/ReadSpec → convergence/SinglePassMode", () => {
  ...
  it("connection: convergence/SinglePassMode → convergence/SkipToWatchIfConverged", () => {
  ...
  it("connection: convergence/SkipToWatchIfConverged → convergence/SkipToWatchIfConverged", () => {
  ...
  it("connection: convergence/SkipToWatchIfConverged → publish/ComputeInterfaceHash", () => {
  ...
  it("connection: publish/ComputeInterfaceHash → convergence/SkipToWatchIfConverged", () => {
  ...
  it("connection: convergence/SkipToWatchIfConverged → convergence/EnterSleepMode", () => {
