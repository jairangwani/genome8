...
describe("CollectExternalDependenciesForInterface", () => {
  ...
  it("connection: publish/CollectExportedNodes → publish/CollectExternalRequires", () => {
  ...
  it("connection: publish/CollectExternalRequires → publish/CollectExternalRequires", () => {
  ...
  it("connection: publish/CollectExternalRequires → publish/GenerateInterfaceYaml", () => {
