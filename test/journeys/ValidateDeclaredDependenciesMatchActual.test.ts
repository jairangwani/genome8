...
describe("ValidateDeclaredDependenciesMatchActual", () => {
  ...
  it("connection: organization/DependencyGraph → graph/CompiledIndex", () => {
  ...
  it("connection: graph/CompiledIndex → convergence/ValidateDependencyGraphAccuracy", () => {
  ...
  it("connection: convergence/ValidateDependencyGraphAccuracy → convergence/ValidateDependencyGraphAccuracy", () => {
  ...
  it("connection: convergence/ValidateDependencyGraphAccuracy → compilation/ErrorReport", () => {
  ...
  it("connection: compilation/WarningReport → convergence/ConvergenceState", () => {
