...
describe("SkipCodegenWhenFullyConverged", () => {
  ...
  it("connection: codegen/NeverOverwriteExisting → codegen/NeverOverwriteExisting", () => {
  ...
  it("connection: codegen/NeverOverwriteExisting → organization/DependencyGraph", () => {
  ...
  it("connection: organization/DependencyGraph → codegen/ConfirmAllModulesFilled", () => {
  ...
  it("connection: codegen/ConfirmAllModulesFilled → codegen/ConfirmAllModulesFilled", () => {
