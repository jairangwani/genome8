...
describe("SkipTestsForUnfilledModule", () => {
  ...
  it("connection: testgen/SelectNextTestToFill → testgen/DetectMissingImplementation", () => {
  ...
  it("connection: testgen/DetectMissingImplementation → codegen/GeneratedCodeDirectory", () => {
  ...
  it("connection: codegen/GeneratedCodeDirectory → testgen/DetectMissingImplementation", () => {
  ...
  it("connection: testgen/DetectMissingImplementation → testgen/DetectMissingImplementation", () => {
  ...
  it("connection: testgen/DetectMissingImplementation → testgen/TestResultReport", () => {
